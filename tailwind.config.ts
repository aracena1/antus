    ...
    extend: {
      ...
      keyframes: {
        ...
        "confetti": {
          ...
          "100%": {
            transform: "translateY(120vh) translateX(var(--confetti-x, 0)) rotate(var(--confetti-rotate, 720deg))",
            opacity: "0"
          }
        }
      },
